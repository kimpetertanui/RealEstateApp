                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="demon" class="collapse">
                            ...
                            <li>
                                <a href="view_room.php" class="glyphicon glyphicon-eye-open">&nbsp;View Rental Houses</a>
                            </li>
                        </ul>
                    </li>
                    <li class="active">
		...
		<div class="col-md-12">
			...
			<div>
				<div class="form-group">
							  <label class="col-md-5 control-label" for="room">Rental House:</label>  
							  <div class="col-md-3">
				...
				<div class="form-group">
							  <label class="col-md-5 control-label" for="rental">Other Name:</label>
							  <div class="col-md-3">
						<input type="text" name="nname" id = "nname" class="form-control input-md"  placeholder="Othername" required/>
					</div>
				</div>
				<div>
					<div class="form-group">
				...
				<div class="form-group">
							  <label class="col-md-5 control-label" for="rental">ID.No:</label>
							  <div class="col-md-3">
						<input type="number" name="age" id = "age" class="form-control input-md" title="input number only" placeholder="ID Number" required/>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
							  <label class="col-md-5 control-label" for="rental">Registration date:</label>
							  <div class="col-md-3">
