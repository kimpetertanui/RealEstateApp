    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <div class="span3">&nbsp;&nbsp;&nbsp;&nbsp;<img class="index_logo" height="45" width="100" src="assets/img/marathon.png"></div>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demon"><i class="fa fa-sitemap fa"></i> Rental Houses <i class="fa fa-fw fa-caret-down"></i></a>
					...
					<li>
                        <a href="tenant_log.php"><i class="glyphicon glyphicon-sort"></i> Client Logs</a>
                    </li>
                    <li>
		...
		<div id="page-wrapper">
            <div class="container-fluid">
				...
				<?php
					...
					?>
				<center><h4><strong>Client Form, Rental Houses&nbsp;<?php echo $room_name; ?></strong><h4></center>
				<div class="col-sm-12">
				<div class="span7" id="">  
                     <div class="row-fluid">
					  <?php	
					   ...
					   <!-- Modal -->
						...
						?>
								...
								<p><i style="color:red"><h4>Note: Please check the checkbox if you want to delete a Tenant!!!</h4></i></p>
                                </div>
                            </div>
                        </div>
					</div>
