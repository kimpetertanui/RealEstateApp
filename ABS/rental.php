...
<div id="page-wrapper">
            <div class="container-fluid">
				...
				<nav>
				<head>
				<center><h4><strong>Monthly Rent</strong><h4></center>
					   <div class="col-sm-12">
								...
								<!-----------------------form --------------------->
									...
									<thead>
										  ...
										  <th></th>
												...
												<th><center><strong>Rent Amount</strong></center></th>
												<th></th>
										   </tr>
										</thead>
										<tbody>
									<?php
												...
												<td class="col-md-1">
												<center><a button class="btn btn-success" title="Click here to View." href="edit_rental.php<?php echo '?id='.$row['room_id'];?>">Edit Rent</a></center></td>
											</center>
