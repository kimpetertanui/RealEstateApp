        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        <a href="javascript:;" data-toggle="collapse" data-target="#demon"><i class="fa fa-sitemap fa"></i>Appartment House<i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="demon" class="collapse">
							<li>
                                <a href="processAdd_room.php" class="glyphicon glyphicon-plus">&nbsp;Add Appartment House</a>
                            </li>
                            <li>
                                <a href="view_room.php" class="glyphicon glyphicon-eye-open">&nbsp;View Appartment House</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul id="demo" class="collapse">
							<li>
                                <a href="register.php" class="glyphicon glyphicon-plus">&nbsp;Add Client</a>
                            </li>
                            <li>
                                <a href="tenant_room.php" class="glyphicon glyphicon-eye-open">&nbsp;View Client</a>
                            </li>
                        </ul>
                    </li>
                    <li>
					...
					<li>
                        <a href="tenant_log.php"><i class="glyphicon glyphicon-sort"></i> Clients Logs</a>
                    </li>
                    <li>
			...
			<br>
				...
				<head>
					   ...
					   <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						...
						?>
							<center><h4><strong>View Rental Houses</strong></h4></center>
					   <div class="col-sm-12">
								...
								<!-----------------------form --------------------->
									...
									&nbsp;&nbsp;<button type='button' class="btn btn-danger" data-toggle='modal' data-target='#myModal'><i class="glyphicon glyphicon-trash"></i></button>
										...
										<thead>
										  <tr>
												<th></th>
												<th>House</th><div class="muted pull-right">&nbsp;Rental Houses Available</div><div class="muted pull-right"><span class="label label-warning"><?php echo $count;?></span></div>
									...
									<?php
												...
												<td class="col-md-1">
												<center><a button class="btn btn-success" title="Click here to edit this room." href="edit_room.php<?php echo '?id='.$row['room_id'];?>">Edit House</a></center></td>
											</center>
